        ...
        <form onSubmit={handleSaveDraft} className={`${cardClass} max-w-3xl mx-auto`}>
            ...
            <div className="space-y-6">
                ...
                <div>
                    ...
                    <p className="text-xs text-slate-500 mt-1.5">PNG or JPG. Recommended 1:1 or 1.91:1 ratio.</p>
                </div>
                
                <div>
                    <label htmlFor="primary_text" className={labelClass}>Primary Text* (The main caption)</label>
                ...
                <div>
                    ...
                    <input type="url" id="website_url" name="website_url" value={formState.website_url} onChange={handleFormChange} className={inputClass} required placeholder="https://www.your-website.com" />
                </div>

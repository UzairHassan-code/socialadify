...
const AdminIcon = () => (
    <IconWrapper colorClass="bg-red-600/20 group-hover:bg-red-600/30" iconColorClass="text-red-300 group-hover:text-red-200">
...
const ModuleCard: React.FC<ModuleCardProps> = ({
  ...
  return (
    <Link href={link} className="block focus:outline-none focus:ring-4 focus:ring-blue-500/60 focus:ring-offset-4 focus:ring-offset-slate-900 rounded-2xl">
      <div className="group-hover:text-blue-300 transition-colors"> {/* Added this wrapper for consistent hover effect */}

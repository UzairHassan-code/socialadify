...
const SocialAdifyLogoIcon = ({ className = "w-8 h-8" }: {className?: string}) => ( <svg className={className} viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"> <defs> <linearGradient id="socialAdifyLogoGradientInsightsLayout" x1="0%" y1="0%" x2="100%" y2="100%"> <stop offset="0%" style={{stopColor: 'rgb(234, 179, 8)'}} /> <stop offset="50%" style={{stopColor: 'rgb(249, 115, 22)'}} /> <stop offset="100%" style={{stopColor: 'rgb(239, 68, 68)'}} /> </linearGradient> </defs> <circle cx="50" cy="50" r="45" fill="url(#socialAdifyLogoGradientInsightsLayout)" /> <path d="M30 60 Q40 40 50 50 T70 40 M30 60 L35 70 M70 40 L65 30" stroke="rgba(255,255,255,0.8)" strokeWidth="5" fill="none" strokeLinecap="round"/> </svg> );
...
export default function SocialInsightsLayout({ children }: { children: ReactNode; }) {
    ...
    return (
        <ProtectedRoute>
            ...
            <div className="min-h-screen flex flex-col bg-gradient-to-br from-slate-900 via-gray-900 to-indigo-950 text-slate-100">

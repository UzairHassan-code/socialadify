...
} from '@/services/socialInsightsService'; // <-- Corrected path
...
// --- Component Imports ---
import InsightsDateRangePicker from '@/components/InsightsDateRangePicker'; // <-- Corrected path
import StatCard from '@/components/StatCard';
// --- NEW: Import the chart and table components ---
...
export default function SocialInsightsPage() {
    ...
    // --- FIX: Use type assertion to access properties we know exist ---
    ...
    const fetchData = useCallback(async () => {
        ...
        // Check for connections *before* setting loading to true
    ...
    const handlePlatformChange = (newPlatform: Platform) => {
        // Reset error state on platform change, fetchData will handle the new error
        setError(null);
            ...
            <div className="max-w-7xl mx-auto">
                ...
                {!loading && !error && pageInsights && postInsights && (
                    <div className="space-y-8">
                        {/* --- Section 1: Total Stats Cards (UPDATED) --- */}
                        ...
                        {/* --- Section 2: Page Trends Chart (UPDATED) --- */}
                        ...
                        {/* --- Section 3: Post Insights Table (UPDATED) --- */}
                        <div className="bg-slate-800/60 backdrop-blur-md shadow-xl rounded-2xl p-6 border border-slate-700 text-slate-300">

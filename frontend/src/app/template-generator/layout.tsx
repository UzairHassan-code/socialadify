...
const SocialAdifyLogoIcon = ({ className = "w-8 h-8" }: {className?: string}) => ( <svg className={className} viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"> <defs> <linearGradient id="socialAdifyLogoGradientHistoryLayout" x1="0%" y1="0%" x2="100%" y2="100%"> <stop offset="0%" style={{stopColor: 'rgb(192, 132, 252)'}} /> <stop offset="50%" style={{stopColor: 'rgb(124, 58, 237)'}} /> <stop offset="100%" style={{stopColor: 'rgb(219, 39, 119)'}} /> </linearGradient> </defs> <circle cx="50" cy="50" r="45" fill="url(#socialAdifyLogoGradientHistoryLayout)" /> <path d="M35 65 L35 35 Q50 25 65 35 L65 65 Q50 75 35 65 Z M50 42 A8 8 0 0 1 50 58 A8 8 0 0 1 50 42 Z" fill="white" /> </svg> );
                        ...
                        <div className="flex items-center justify-between h-16 md:h-20">
                            <div className="flex items-center">
                                <Link href="/home" className="flex items-center gap-3 group">
                                    ...
                                    <span className="text-xl sm:text-2xl font-bold text-slate-50 group-hover:text-purple-400 transition-colors duration-300 tracking-tight">
                                        SocialAdify
                                    </span>
                                </Link>
                                 {/* --- NEW: Added full navigation bar for desktop --- */}

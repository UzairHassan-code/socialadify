...
const SocialAdifyLogoIcon = ({ className = "w-8 h-8" }: {className?: string}) => (
    <svg className={className} viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
        <defs>
            {/* Using a different ID just in case of conflicts */}
            <linearGradient id="socialAdifyLogoGradientAdCreatorLayout" x1="0%" y1="0%" x2="100%" y2="100%">
                <stop offset="0%" style={{stopColor: 'rgb(107, 229, 163)'}} />
                <stop offset="50%" style={{stopColor: 'rgb(59, 130, 246)'}} />
                <stop offset="100%" style={{stopColor: 'rgb(14, 165, 233)'}} />
            </linearGradient>
        </defs>
        <circle cx="50" cy="50" r="45" fill="url(#socialAdifyLogoGradientAdCreatorLayout)" />
...
const navLinks = [
    ...
    // NOTE: We will add "/ad-creator" to this list later if desired
];

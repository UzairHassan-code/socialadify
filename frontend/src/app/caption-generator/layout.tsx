...
const SocialAdifyLogoIcon = ({ className = "w-8 h-8" }: {className?: string}) => (
    <svg className={className} viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
        <defs>
            <linearGradient id="socialAdifyLogoGradientCaptionGenLayout" x1="0%" y1="0%" x2="100%" y2="100%">
        ...
        <circle cx="50" cy="50" r="45" fill="url(#socialAdifyLogoGradientCaptionGenLayout)" />
...
export default function CaptionGeneratorLayout({
  ...
  console.log("CaptionGeneratorLayout: Rendering. ProtectedRoute will apply.");
    ...
    <ProtectedRoute>
      <div className="min-h-screen flex flex-col bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 text-slate-100">
        ...
        <main className="flex-grow container mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
          {children} {/* This will be your caption-generator/page.tsx */}
        </main>

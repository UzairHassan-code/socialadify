                  ...
                  >
                    {profilePicUrl ? (
                        <Image 
                            ...
                            width={40} 
                            height={40}
                            className="rounded-full object-cover ring-1 ring-slate-600 group-hover:ring-blue-300 transition-all"
                            onError={(e) => { (e.target as HTMLImageElement).style.display = 'none'; }}
                        />
                    ) : (
                        <UserIcon className="h-8 w-8 text-slate-300 group-hover:text-blue-300 transition-colors" /> 
                    )}
                    {user.firstname && (

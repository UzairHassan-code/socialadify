    ...
    return (
        <div className="py-12 sm:py-16 px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto">
                <div className="mb-4">
                    <Link href="/account" className="inline-flex items-center gap-2 text-sm text-slate-300 hover:text-indigo-400 transition-colors">
                        ...
                        {adAccounts.length > 0 && !isGoogleConnected && (
                            <div className="space-y-4 mb-6">
                                ...
                                <select
                                    ...
                                    className="w-full p-2.5 bg-slate-700/50 border border-slate-600 rounded-lg shadow-sm"
                                >
                                ...
                                <button
                                    ...
                                    className="w-full flex items-center justify-center px-5 py-2.5 text-sm font-semibold rounded-lg shadow-md bg-indigo-600 hover:bg-indigo-500 text-white disabled:opacity-70"
                                >

...
const HistoryIcon = ({ className = "w-6 h-6" }: { className?: string }) => ( <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor"> <path strokeLinecap="round" strokeLinejoin="round" d="M12 6.042A8.967 8.967 0 006 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 016 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 016-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0018 18a8.967 8.967 0 00-6 2.292m0-14.25v14.25" /> </svg> );
const AlertTriangleIcon = ({ className = "w-5 h-5 text-red-300" }: { className?: string }) => ( <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" > <path strokeLinecap="round" strokeLinejoin="round" d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126zM12 15.75h.007v.008H12v-.008z" /> </svg> );
            ...
            <div className="py-12 sm:py-16 px-4 sm:px-6 lg:px-8">
                <div className="max-w-3xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                        ...
                        <Link href="/history" className="group block p-6 bg-slate-800/60 backdrop-blur-md shadow-xl rounded-2xl hover:bg-slate-700/80 hover:border-sky-500/70 border border-slate-700 transition-all duration-300 ease-in-out transform hover:-translate-y-1">
                            <div className="flex items-center mb-2">
                                <HistoryIcon className="w-6 h-6 text-sky-400 mr-3 group-hover:text-sky-300 transition-colors" />
                                <h3 className="text-lg font-semibold text-slate-100 group-hover:text-sky-300 transition-colors">Content History</h3>
                            </div>
                            <p className="text-sm text-slate-400">View and manage your saved content.</p>
                        </Link>
                        
                        {/* --- *** NEW LINK TO CONNECTIONS PAGE *** --- */}
                        <Link href="/connections" className="group block p-6 bg-slate-800/60 backdrop-blur-md shadow-xl rounded-2xl hover:bg-slate-700/80 hover:border-emerald-500/70 border border-slate-700 transition-all duration-300 ease-in-out transform hover:-translate-y-1">
                            <div className="flex items-center mb-2">
                                <LinkIcon className="w-6 h-6 text-emerald-400 mr-3 group-hover:text-emerald-300 transition-colors" />
                                <h3 className="text-lg font-semibold text-slate-100 group-hover:text-emerald-300 transition-colors">Connected Accounts</h3>
                            </div>
                            <p className="text-sm text-slate-400">Manage your Meta and Google integrations.</p>
                        </Link>

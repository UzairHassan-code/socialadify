...
// --- Icon Components (kept local for simplicity) ---
...
const SocialAdifyLogoIcon = ({ className = "w-8 h-8" }: {className?: string}) => (
    <svg className={className} viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
        <defs>
            <linearGradient id="socialAdifyLogoGradientPostGenLayout" x1="0%" y1="0%" x2="100%" y2="100%">
        ...
        <circle cx="50" cy="50" r="45" fill="url(#socialAdifyLogoGradientPostGenLayout)" />
...
export default function PostGeneratorLayout({
    children,
}: {
    children: ReactNode;
}) {
            ...
            <div className="min-h-screen flex flex-col bg-gradient-to-br from-slate-900 via-gray-900 to-sky-950 text-slate-100">
                ...
                <footer className="bg-slate-900/60 border-t border-slate-700/50 text-center py-6 mt-auto">
                    <p className="text-xs text-slate-500">
                        © {new Date().getFullYear()} SocialAdify. AI Post Generation Module.
                    </p>
                </footer>
            </div>
        </ProtectedRoute>

...
import { generateVisualPost, saveVisualPost, PostGenerationPayload, PostGenerationResult } from '@/services/postGeneratorService';
...
export default function PostGeneratorPage() {
    ...
    const handleInputChange = (field: keyof PostGenerationPayload, value: string) => {
    ...
    return (
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div className="max-w-4xl mx-auto">
                {pageState === 'form' && (
                    <form onSubmit={handleSubmit} className={`${cardClass} max-w-2xl mx-auto space-y-6`}>
                        {/* Form fields */}
                        <div>

        ...
        <div className="relative overflow-hidden py-8 md:py-12"> {/* Added vertical padding */}
            ...
            <div className="relative z-10 space-y-10"> {/* Keep content above pattern */}
                ...
                <section className="max-w-4xl mx-auto">
                    {/* User Management Card - Now centered since it's alone */}
                    <div className="max-w-md mx-auto">
                        <Link href="/admin/users" className="group block">
                            <div className="bg-slate-900 backdrop-blur-md shadow-2xl rounded-xl p-6 sm:p-8 border border-slate-800 hover:border-indigo-500/70 transition-all duration-300 ease-in-out transform hover:-translate-y-1 hover:shadow-indigo-500/30 h-full"> {/* MODIFIED: Changed hover border/shadow colors */}
